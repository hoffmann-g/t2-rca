...
echo ""
echo "[4/4] softflowd + ntopng — open two more terminals and run:"
echo ""
echo "  ┌─ Terminal 2 (softflowd) ──────────────────────────────────────"
echo "  │  sudo softflowd -i $IFACE -n 127.0.0.1:2055 -v 9 -t maxlife=60"
echo "  └───────────────────────────────────────────────────────────────"
echo ""
echo "  ┌─ Terminal 3 (ntopng via Docker) ──────────────────────────────"
echo "  │  docker run -it --net=host -p 3000:3000 ntop/ntopng -i 0.0.0.0:2055"
echo "  └───────────────────────────────────────────────────────────────"
echo ""
